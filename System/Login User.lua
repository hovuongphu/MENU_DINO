...
local aaa = Instance.new("ImageLabel")
...
main_2.Size = UDim2.new(0, 432, 0, 396)

Open_Premium_main.Name = "Open_Premium_main"
Open_Premium_main.Parent = main_2
...
Open_Gift_Code_main.Parent = main_2
...
Open_Infinity_main.Parent = main_2
...
aaa.Position = UDim2.new(0.0578703694, 0, 0.0808080807, 0)
aaa.Size = UDim2.new(0, 382, 0, 96)
aaa.Image = "rbxassetid://3570695787"
aaa.ImageColor3 = Color3.fromRGB(40, 40, 40)
aaa.ScaleType = Enum.ScaleType.Slice
aaa.SliceCenter = Rect.new(100, 100, 100, 100)
aaa.SliceScale = 0.120

ImageLabel.Parent = aaa
