...
function Counter_Blox()
	...
	local function LWRG_fake_script() -- DinoOwl.LocalScript 
		local script = Instance.new('LocalScript', DinoOwl)

		local Dino = script.Parent.Frame.DinoHud
		local Owl = script.Parent.Frame.Owl
		local Frame = script.Parent.Frame

		Dino.MouseButton1Click:Connect(function()
			Frame.Visible = false
	...
	coroutine.wrap(LWRG_fake_script)()
