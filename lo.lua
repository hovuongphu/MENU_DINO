...
for _,v in pairs(game.workspace.Collectibles:GetChildren()) do
    ...
    VersionText.Text = "Version: 1.1.2"
    ...
    ImageGang.Image = "http://www.roblox.com/asset/?id=6747389071"
    ...
    CreditText.Text = "Gui Create : DINO#5485"
    ...
    DiscordlinkTest.Text = "Link: dinohud.netlify.app"
    ...
    Copylinkdiscord.Text = "COPY LINK WebDinoHud"
    ...
    setclipboard("dinohud.netlify.app")
    end)
